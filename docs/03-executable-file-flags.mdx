...
Options:
  ...
  -K, --ssl-key <SSL_KEY>
      ...
      --bancho-state-dump-path <BANCHO_STATE_DUMP_PATH>
          [default: ./.service_dump/bancho_state.dump]

      --bancho-state-dump-type <BANCHO_STATE_DUMP_TYPE>
          [default: binary]
          [possible values: binary, json]

      --bancho-state-save-dump


      --bancho-state-load-dump


      --bancho-state-dump-expries <BANCHO_STATE_DUMP_EXPRIES>
          [default: 300]
...
Options:
  ...
  -K, --ssl-key <SSL_KEY>
      ...
      --chat-dump-path <CHAT_DUMP_PATH>
          [default: ./.service_dump/chat.dump]

      --chat-dump-type <CHAT_DUMP_TYPE>
          [default: binary]
          [possible values: binary, json]
      ...
      --chat-dump-expries <CHAT_DUMP_EXPRIES>
          [default: 300]
